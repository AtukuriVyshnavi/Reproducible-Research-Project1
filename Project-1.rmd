...
hist(x$steps, type="h", lwd = 7, ylab="Frequency", xlab="steps",main="Total steps per day")
```
...
hist(imputedsum$steps, type="h", lwd = 7, ylab="Frequency", xlab="steps",main="Total steps per day with NA's Fixed",col="Black") hist(x$steps, type="h", lwd = 7, ylab="Frequency", xlab="steps",main="Total steps per day with NA's Fixed",col="grey")
